...
def chat_com_fiis(context: str, history: Iterable[dict], user_message: str,
    ...
    system = (
        ...
        "11. A renda recorrente é a que decide. Ao citar rendimento, use DY recorrente "
        "(dy_12m × income_recurrence) e informe o DY divulgado ao lado; nunca apresente "
        "o DY divulgado sozinho como se fosse renda sustentável.\n"
        "12. Evidência de proteção marcada como 'não divulgado pelo gestor' é um fato sobre "
        "o fundo, não uma lacuna do sistema. Ao citar esse fundo, nomeie a proteção não "
        "divulgada e não trate sua ausência como ausência de risco.\n\n"
