...
_US_INDUSTRY_EXACT = {
    "accident & health insurance": "Seguros de Acidentes e Saúde",
    "adhesives & sealants": "Adesivos e Selantes",
    "agricultural chemicals": "Produtos Químicos Agrícolas",
    "agricultural operations": "Operações Agrícolas",
    "aerospace & defense": "Aeroespacial e Defesa",
    "air freight & logistics": "Carga Aérea e Logística",
    "airlines": "Companhias Aéreas",
    "airports & air services": "Aeroportos e Serviços Aéreos",
    "aluminum": "Alumínio",
    "asset management": "Gestão de Ativos",
    "apparel manufacturing": "Fabricação de Vestuário",
    "apparel retail": "Varejo de Vestuário",
    "auto & truck dealerships": "Concessionárias de Automóveis e Caminhões",
    ...
    "business equipment & supplies": "Equipamentos e Suprimentos Empresariais",
    ...
    "confectioners": "Confeitaria e Doces",
    ...
    "education & training services": "Serviços de Educação e Treinamento",
    "engineering & construction": "Engenharia e Construção",
    "entertainment": "Entretenimento",
    "farm products": "Produtos Agrícolas",
    "farm & heavy construction machinery": "Máquinas Agrícolas e de Construção Pesada",
    "financial conglomerates": "Conglomerados Financeiros",
    ...
    "home improvement retail": "Varejo de Materiais para Reforma",
    ...
    "lodging": "Hospedagem",
    "leisure": "Lazer",
    "lumber & wood production": "Produção de Madeira",
    "luxury goods": "Artigos de Luxo",
    "marine shipping": "Transporte Marítimo",
    "medical care facilities": "Estabelecimentos de Saúde",
    "medical devices": "Dispositivos Médicos",
    "medical distribution": "Distribuição de Produtos Médicos",
    "medical instruments & supplies": "Instrumentos e Suprimentos Médicos",
    "metal fabrication": "Fabricação de Produtos Metálicos",
    ...
    "pharmaceutical retailers": "Varejo Farmacêutico",
    "pollution & treatment controls": "Controle de Poluição e Tratamento",
    "primary production of aluminum": "Produção Primária de Alumínio",
    "railroads": "Ferrovias",
    "publishing": "Publicação e Editoras",
    "real estate services": "Serviços Imobiliários",
    "recreational vehicles": "Veículos Recreativos",
    "rental & leasing services": "Serviços de Aluguel e Arrendamento",
    "residential construction": "Construção Residencial",
    ...
    "scientific & technical instruments": "Instrumentos Científicos e Técnicos",
    "security & protection services": "Serviços de Segurança e Proteção",
    "shell companies": "Empresas sem Operação",
    "software - application": "Software de Aplicação",
    "software - infrastructure": "Software de Infraestrutura",
    "solar": "Energia Solar",
    "specialty business services": "Serviços Empresariais Especializados",
    ...
    "staffing & employment services": "Serviços de Recrutamento e Emprego",
    "steel": "Aço",
    "telecom services": "Serviços de Telecomunicações",
    "textile manufacturing": "Fabricação de Têxteis",
...
_US_SECTOR_KEYWORDS = (
    ...
    ("Materiais Básicos", ("mining", "metal", "steel", "aluminum", "chemical", "paper",
                           "lumber", "forestry", "cement", "glass", "mineral", "adhesive",
                           "sealant", "coating", "rubber", "plastic")),
