...
_UPDATE_COLS = {
    ...
    "fii_metric_observations": ("value_numeric", "value_text", "value_json",
                                ...
                                "metadata_json", "observed_at", "source_published_at",
                                "knowledge_at", "availability_quality", "content_hash",
                                "source_release_id"),
    "fii_exposures": ("exposure_weight", "raw_payload_id", "metadata_json",
                      "source_published_at", "knowledge_at", "availability_quality",
                      "content_hash", "source_release_id"),
